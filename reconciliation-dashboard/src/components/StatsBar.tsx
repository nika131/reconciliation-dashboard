    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="text-sm text-slate-600 mt-1">{totalAmount.toLocaleString()} GEL</div>
            </div>
            ...
            <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-100 shadow-sm">
                ...
                <div className="text-sm text-emerald-600 mt-1">{matchedAmount.toLocaleString()} GEL</div>
            </div>
            ...
            <div className="bg-rose-50 p-4 rounded-xl border border-rose-100 shadow-sm">
                ...
                <div className="text-sm text-rose-600 mt-1">{ignored.length} Ignored</div>
            </div>
